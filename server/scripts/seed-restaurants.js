...
// 18 of 27 restaurants scatter organically around the city center
// (Officers' Palace to 10th khoroolol), elongated east-west rather than
// north-south; the remaining 9 sit further out toward the city's outskirts
// in varied directions. Kept in sync with
...
const restaurants = [
  ...
  ["Amber Terrace", "10th khoroolol area", 47.8986, 106.8252],
  ["Mellow Garden", "Amgalan bridge area", 47.9346, 106.9914],
  ["The Brass Bar", "Bogd Khan foothills, south-west edge", 47.7774, 106.8411],
  ["Aurora Lounge", "Peace Avenue east side", 47.9418, 107.0035],
  ["Nomad Table", "3rd khoroolol area", 47.9103, 106.8601],
  ["Crown & Smoke", "Chingeltei north edge", 48.0193, 106.8912],
  ["Saffron Rooftop", "Nisekh east edge", 47.9617, 107.0953],
  ["Luna Bistro", "Officers' Palace area, city center", 47.9148, 106.9043],
  ["Echo Lounge", "State Department Store area", 47.9471, 106.8896],
  ["Golden Hour", "Gandan area", 47.9256, 106.8024],
  ["Urban Flame", "Peace Avenue central-west", 47.9328, 106.8721],
  ["Opal Room", "5th khoroolol area", 47.9283, 106.848],
  ["Mint Social", "Amgalan area", 47.9211, 107.0129],
  ["Horizon Grill", "Bogd Khan foothills, west edge", 47.8941, 106.8131],
  ["Cedar Lounge", "Zaisan foothill area", 47.8968, 106.9794],
  ["Ivory Table", "Sansar area", 47.9445, 106.9673],
  ["Copper House", "Songino Khairkhan far west edge", 47.8637, 106.6935],
  ["Jade Garden", "Bogd Khan foothills, south edge", 47.8879, 106.8359],
  ["Monarch Lounge", "Zaisan south edge", 47.8129, 106.975],
  ["Naran Terrace", "Sukhbaatar Square vicinity", 47.904, 106.9365],
  ["Pearl Bistro", "Tolgoit far west edge", 47.9611, 106.7426],
  ["Aria Lounge", "13th khoroolol area", 47.9238, 106.9526],
  ["Tempo Kitchen", "Nisekh far south-east edge", 47.8906, 107.0236],
  ["Breeze Rooftop", "10th khoroolol east side", 47.9085, 106.9204],
