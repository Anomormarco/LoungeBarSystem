  ...
  return (
    <UserLayout>
      <div className="mx-auto w-full max-w-3xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <h1 className="mt-2 text-3xl font-extrabold text-white sm:text-4xl">{TERMS_OF_SERVICE.title}</h1>
        <p className="mt-2 text-sm text-lounge-muted">Сүүлд шинэчилсэн: {TERMS_OF_SERVICE.updated}</p>
