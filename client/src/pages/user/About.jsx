    ...
    <UserLayout>
      <main className="bg-[#15130f] text-[#e8e1db]">
        <section className="relative flex min-h-[86vh] items-center overflow-hidden">
          ...
          <div className="relative z-10 mx-auto w-full max-w-[1280px] px-4 py-24 sm:px-6 lg:px-16">
        ...
        <section className="mx-auto max-w-[1280px] px-4 py-28 sm:px-6 lg:px-16">
        ...
        <section className="relative overflow-hidden py-28">
          ...
          <div className="mx-auto grid max-w-[1280px] grid-cols-1 items-center gap-16 px-4 sm:px-6 md:grid-cols-2 lg:px-16">
